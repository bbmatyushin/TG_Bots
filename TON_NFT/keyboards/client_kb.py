...
inl_b5_collection = InlineKeyboardButton(text="METAMORPHOSES", callback_data='metamorphoses')
inl_b6_collection = InlineKeyboardButton(text="CALLIGRAFUTURISM — 24: Units", callback_data='calligrafuturism_24_units')
# Choice result
...
inl_kb_collection.add(inl_b1_collection, inl_b2_collection,
                      ...
                      inl_b5_collection, inl_b6_collection)
